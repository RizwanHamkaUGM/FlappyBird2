public interface GameConstants {
    ...
    String DEFAULT_MAIN_MENU_BG_PATH = "./assets/menu/main_background.png"; // Generic fallback
    String MAIN_MENU_BG_SKIN_PREFIX = "./assets/menu/main_background_"; // e.g., main_background_level1.png
    ...
    // Game Over Image
    String GAME_OVER_IMG_PATH = "./assets/menu/game_over.png"; // New asset for game over screen
}